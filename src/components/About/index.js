      ...
      >
        ...
        >
          <Typography
            variant="body1"
            align="center"
            sx={{ fontSize: { lg: 24, md: 14, sm: 10 } }}
            paragraph
          >
            Hello! Engineer in training seeking employment that will allow me to utilize my creativity, inventiveness, and exceptional attention to detail. !
          </Typography>
        </Container>
        <Container maxWidth="sm">
          <Box textAlign="center" sx={{ borderBottom: "solid 1px" }}>
            <Divider
              sx={{
          ...
          <Box textAlign="center" sx={{ mb: "10px" }}>
            <IconButton
              onClick={() =>
                window.open(
                  "https://www.linkedin.com/in/ellysecarter/",
                  "_blank"
                )
              }
            >
            ...
            <IconButton
              onClick={() =>
                window.open("https://github.com/ellysecarter", "_blank")
              }
            >
              <GitHubIcon
                style={{ color: "#F0EBD8", paddingRight: "5px" }}
            ...
            <IconButton
              onClick={() => (window.location = "mailto:ellysecarter@yahoo.com")}
            >
              <EmailIcon
                fontSize="large"
                style={{ color: "#F0EBD8", paddingRight: "5px" }}
